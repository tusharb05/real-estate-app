...
export const WelcomeScreen: FC<WelcomeScreenProps> = observer(
  function WelcomeScreen( // @mst remove-current-line
    ...
    function goNext() {
      ...
      if (userData?.role == "Seeker") navigation.navigate("Seeker", { screen: "SeekerProperties" })
      else if (userData?.role == "Advertiser")
        navigation.navigate("Advertiser", { screen: "AdvertiserProperties" })
      else if (userData?.role == "Admin")
        navigation.navigate("Admin", { screen: "AdminProperties" })
    }
